...
```
The data for the locations looks like not all locations reached a critical point (Door, Oconto) and fertility response was poor at Dane County. John recommended trying 4 models (linear-plateau, quadratic, linear?, and quadratic?). First, I'm going to start with  Dunn County to get my feet wet. Cleaning some data points could help.
